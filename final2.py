    ...
    def tab1func():
        ...
        def func():
            ...
            if val3 == "" or val2 == "" or val5 == "" or val4 == "" or val1 == "":
                ...
                list_of_items = [['Stiffness for tension [N/m]',val1],['Stiffness for Compression [N/m]',val2],['Clamp on catenary wire [Kg]',val3],['Clamp on Contact wire [Kg]',val4],['Mass per unit length [Kg/m]',val5]]
                for items in list_of_items :
                    connn.execute("INSERT INTO Droppers VALUES (?,?)",(items[0],items[1]))
        ...
        def func2():
            ...
            if type_of_wire.get()=="1":
                ...
                ls.append(connn.execute("SELECT * FROM MessengerWireSupport").fetchall())
    ...
    def tab2func():
        ...
        def func():
            ...
            if val3 == "" or val2 == "" or val5 == "" or val4 == "" or val1 == "" or val6 == "":
                ...
                list_of_items = [['Span Length [m]',val1],['Encumbrance [m]',val2],['Length of Stitch Wire [m]',val3],['Maximum Presag at Midspan [mm]',val4],['Stagger of Contact Wire [m]',val5],['Stagger of Catenary Wire [m]',val6]]
                for items in list_of_items :
                    connn.execute("INSERT INTO Geometry VALUES (?,?)",(items[0],items[1]))
                conn.commit()
                messagebox.showinfo("All values are saved")
    ...
    def tab3func():
        ...
        def fun():
            ...
            if val3 == "" or val2 == "" or val5 == "" or val4 == "" or val1 == "":
                ...
                list_of_items = [['Number of Contact Wires',val1],['Tension per Wire [N]',val2],['Mass per length Unit [kg/m]',val3],['Youngs Modules [kN/mm^2]',val4],['Cross Section [mm^2]',val5]]
                for items in list_of_items :
                    connn.execute("INSERT INTO ContactWire VALUES (?,?)",(items[0],items[1]))
                conn.commit()
                messagebox.showinfo("All values are saved")
    ...
    def tab4func():
        ...
        def fun():
            ...
            if val3 == "" or val2 == "" or val5 == "" or val4 == "" or val1 == "":
                ...
                list_of_items = [['Number of Messenger Wires',val1],['Young\'s Modulus E [kN/mm^2]',val2],['Area of Cross Section [mm^2]',val3],['Tension [N]',val4],['Mass per length unit [Kg/m]',val5]]
                for items in list_of_items :
                    connn.execute("INSERT INTO MessengerWire VALUES (?,?)",(items[0],items[1]))
                conn.commit()
                messagebox.showinfo("All values are saved")
    ...
    def tab5func():
        ...
        def func():
            ...
            if val3 == "" or val2 == "" or val5 == "" or val4 == "" or val1 == "":
                ...
                list_of_items = [['clamp to Catenary Wire [Kg]',val1],['Young\'s Modulus E [kN/mm^2]',val2],['Area of Cross Section [mm^2]',val3],['Tension [N]',val4],['Mass per length unit [kg/m]',val5]]
                
                for items in list_of_items :
                    connn.execute("INSERT INTO StitchWire VALUES (?,?)",(items[0],items[1]))
                conn.commit()
                messagebox.showinfo("All values are saved")
    ...
    def tab6func():
        ...
        def func():
            ...
            if val3 == "" or val2 == "" or val4 == "" or val1 == "":
                ...
                list_of_items = [['Number of Arms',val1],['Length [m]',val2],['Mass per unit length [Kg/m]',val3],['Mass on clamp [m]',val4]]
                for items in list_of_items :
                    connn.execute("INSERT INTO steadyArm VALUES (?,?)",(items[0],items[1]))
                conn.commit()
                messagebox.showinfo("All values are saved")
    ...
    def tab7func():
        ...
        def func():
            ...
            if val2 == "" or val1 == "":
                ...
                list_of_items = [['Stiffness [KN/m]',val1],['Damping [Ns/m]',val2]]
                for items in list_of_items :
                    connn.execute("INSERT INTO MessengerWireSupport VALUES (?,?)",(items[0],items[1]))
