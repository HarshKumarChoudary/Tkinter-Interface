...
Master = Tk()
Master.title("Pantograph-Catenary Dynamic Interaction Simulation")
# Master.iconbitmap("amtdc_logo.ico")
amtdcIcon = PhotoImage(file="amtdc_logo.png")
Master.iconphoto(True, amtdcIcon)
...
def newWindow():
    if type_of_wire.get() == "":
        messagebox.showwarning(
            "Warning", "Please select a type of wire to proceed")
        return
    ...
    def tab1func():
        ...
        def func():
            ...
            if val3 == "" or val2 == "" or val5 == "" or val4 == "" or val1 == "":
                messagebox.showwarning(
                    "Warning", "Some values are not entered")
            else:
                ...
                conn.commit()
                messagebox.showinfo("Saved", "Values saved into the database")
        ...
        Label(tab1, text='''Stiffness for tension [N/m]''', width=25).grid(
            row=0, column=0, padx=5, pady=13)
        Label(tab1, text='''Stiffness for Compression [N/m]''',
              width=25).grid(row=0, column=2, padx=5, pady=13)
        Label(tab1, text='''Clamp on catenary wire [kg]''', width=25).grid(
            row=1, column=0, padx=5, pady=13)
        Label(tab1, text='''Clamp on Contact wire [kg]''', width=25).grid(
            row=1, column=2, padx=5, pady=13)
        Label(tab1, text='''Mass per unit length [kg/m]''', width=25).grid(
    ...
    def tab2func():
        ...
        def func():
            ...
            # Add function to show image
                ...
                if type_of_wire.get() == '2':
                    top = Toplevel()
                    top.title(
                        "AC - Stitched catenary overhead contact line model")
                ...
                if type_of_wire.get() == '3':
                    top = Toplevel()
                    top.title(
                        "DC-simple catenary overhead contact line model")
        ...
        Label(tab2, text='''Span length [m]''', width=25).grid(
            row=0, column=0, padx=5, pady=13)
        Label(tab2, text='''Encumbrance [m]''', width=25).grid(
            row=0, column=2, padx=5, pady=13)
        Label(tab2, text='''Length of Stitch Wire [m]''', width=25).grid(
            row=1, column=0, padx=5, pady=13)
        Label(tab2, text='''Maximum Presag at Midspan [mm]''',
              width=30).grid(row=1, column=2, padx=5, pady=13)
        Label(tab2, text='''Stagger of Contact Wire [m]''', width=30).grid(
            row=2, column=0, padx=5, pady=13)
        Label(tab2, text='''Stagger of Catenary Wire [m]''',
              width=30).grid(row=2, column=2, padx=5, pady=13)
    ...
    def tab3func():
        ...
        Label(tab3, text='''Number of Contact Wires''', width=25).grid(
            row=0, column=0, padx=5, pady=13)
        Label(tab3, text='''Tension per Wire [N]''', width=25).grid(
            row=0, column=2, padx=5, pady=13)
        Label(tab3, text='''Mass per length Unit [kg/m]''', width=25).grid(
            row=1, column=0, padx=5, pady=13)
        Label(tab3, text='''Youngs Modules E [kN/mm^2]''', width=25).grid(
            row=1, column=2, padx=5, pady=13)
        Label(tab3, text='''Cross Section [mm^2]''', width=25).grid(
            row=2, column=0, padx=5, pady=13)
    ...
    def tab4func():
        ...
        Label(tab4, text='''Young's Modulus E [kN/mm^2]''', width=25).grid(
            row=0, column=2, padx=5, pady=13)
        Label(tab4, text='''Area of Cross Section [mm^2]''', width=25).grid(
            row=1, column=0, padx=5, pady=13)
        Label(tab4, text='''Tension [N]''', width=25).grid(
            row=1, column=2, padx=5, pady=13)
        Label(tab4, text='''Mass per length unit [kg/m]''', width=25).grid(
            row=2, column=0, padx=5, pady=13)
    ...
    def tab5func():
        ...
        Label(tab5, text='''Clamp to Catenary Wire [kg]''', width=25).grid(
            row=0, column=0, padx=5, pady=13)
        Label(tab5, text='''Young's Modulus [kN/mm^2]''', width=25).grid(
            row=0, column=2, padx=5, pady=13)
        Label(tab5, text='''Area of Cross Section [mm^2]''', width=25).grid(
            row=1, column=0, padx=5, pady=13)
        Label(tab5, text='''Tension [N]''', width=25).grid(
            row=1, column=2, padx=5, pady=13)
        Label(tab5, text='''Mass per length unit [kg/m]''', width=25).grid(
            row=2, column=0, padx=5, pady=13)
    ...
    def tab6func():
        ...
        Label(tab6, text='''Number of Arms''', width=25).grid(
            row=0, column=0, padx=5, pady=13)
        Label(tab6, text='''Length [m]''', width=25).grid(
            row=0, column=2, padx=5, pady=13)
        Label(tab6, text='''Mass per unit length [kg/m]''', width=25).grid(
            row=1, column=0, padx=5, pady=13)
        Label(tab6, text='''Mass on clamp [kg]''', width=25).grid(
            row=1, column=2, padx=5, pady=13)
    ...
    def tab7func():
        ...
        # labels
        Label(tab7, text='''Stiffness [kN/m]''', width=15).grid(
            row=0, column=0, padx=5, pady=13)
        Label(tab7, text='''Damping [Ns/m]''', width=15).grid(
            row=1, column=0, padx=5, pady=13)
